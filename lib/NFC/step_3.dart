...
import 'package:hilinky_test/NFC/payment.dart';
import 'package:hilinky_test/components/context.dart';

class step_three extends StatefulWidget {
  const step_three({super.key});

  @override
  step_threeState createState() {
    return step_threeState();
  }
}

class step_threeState extends State<step_three> {
